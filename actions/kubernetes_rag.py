...
class KubernetesRAG(Action):
    def name(self) -> str:
        project_id = os.environ.get("KAPA_K8S_PROJECT_ID", "")
        token = os.environ.get("KAPA_K8S_TOKEN", "")
        num_results = os.environ.get("KAPA_K8S_NUM_RESULTS", 5)
